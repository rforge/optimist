...
matlab <- function() {
  ...
  fact, factors, fftshift, figure, findpeaks, findstr, flipdim, fliplr,
      flipud, fminbnd, fminsearch, fplot, fsolve, fzero,
  gammainc, gcd, geomean, gradient,
  ...
  kron,
  linprog, linspace, loglog, logm, logseq, logspace, lsqcurvefit, lsqlin,
  ...
  ode23, ones, or, orth,
  pascal, pchip, pdist, peaks, perms, piecewise, pinv, plotyy, pol2cart,
      polar, polyfit, polyint, polylog, polyval, pow2, ppval, primes, pwd,
  quad, quad2d, quadgk, quadl, quadv, quiver,
  ...
  sec, sech, semilogx, semilogy, sinc, size, sortrows, sph2cart, sqrtm,
      std, str2num, strcat, strcmp, strcmpi, strfind, strfindi, strjust,
      strrep, subspace,
  tic, toc, trapz, tril, trimmean, triu,
